	...
	do
            ...
            then
              ...
              then
                      ...
                      echo "index=$i: creating MUCH_01_$i";
                      bsub -J MUCH_01_$i root -l -q .x "~/cbmroot/macro/much/much_reco.C($1,$i,0,1)";
              fi            
            fi
            ...
            then
              echo "$jobname does not exist.";
                ...
                then
                        echo "$filename does not exist.";
                        echo "index=$i: creating MUCH_10_$i";
                        bsub -J MUCH_10_$i root -l -q .x "~/cbmroot/macro/much/much_reco.C($1,$i,1,0)";
                fi
            fi
            ...
            then
              echo "$jobname does not exist.";
                ...
                then
                        echo "$filename does not exist.";
                        echo "index=$i: creating MUCH_11_$i";
                        bsub -J MUCH_11_$i root -l -q .x "~/cbmroot/macro/much/much_reco.C($1,$i,1,1)";
                fi            
            fi
done
