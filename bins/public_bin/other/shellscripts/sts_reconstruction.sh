	...
	do
            ...
            then
              ...
              then
                      ...
                      echo "index=$i: creating STS_01_$i";
                      bsub -J STS_01_$i root -l -q .x "~/cbmroot/macro/much/sts_reco.C($1,$i,0,1)";
              fi
            fi
            ...
            then
              ...
              then
                      echo "$filename does not exist.";
                      echo "index=$i: creating STS_10_$i";
                      bsub -J STS_10_$i root -l -q .x "~/cbmroot/macro/much/sts_reco.C($1,$i,1,0)";
              fi
            fi
            ...
            then
              ...
              then
                      echo "$filename does not exist.";
                      echo "index=$i: creating STS_11_$i";
                      bsub -J STS_11_$i root -l -q .x "~/cbmroot/macro/much/sts_reco.C($1,$i,1,1)";
              fi
            fi
